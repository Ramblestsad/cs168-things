...
parser.add_argument(
    "--level", dest="default_level", default="INFO", help="Default log level"
)
parser.add_argument(
    "--address", dest="address", default="127.0.0.1", help="Messenger service address"
)
parser.add_argument(
    "--port", dest="port", default="7790", type=int, help="Messenger service port"
)
