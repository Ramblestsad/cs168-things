...
def launch(log_name="", run_time=3, server_isn=None):
    def setup():
        ...
        capp = c1._new_resocket_app(
            DelayedCloseApp, ip=s1.netdev.ip_addr, port=1000, delay=0.1
        )
        ...
        def do_score():
            ...
            global client_socket
            tester.expect_eq(
                CLOSED, client_socket.state, "At end, client state is CLOSED"
            )
